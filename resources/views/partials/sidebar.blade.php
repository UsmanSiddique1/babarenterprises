  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home-page" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Babar Enterprises</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="home-page" class="d-block">Babar Enterprises</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
           ...
           <!-- <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="add-tax" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Tax</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="view-tax" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Tax Detail</p>
                </a>
              </li>
